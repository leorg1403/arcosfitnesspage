...
export const WA_MESSAGES = {
  ...
  classBooking: (cls: { name: string; day: string; time: string }) =>
    `Hola Arcos Fitness, quiero reservar la clase de ${cls.name} el ${cls.day} a las ${cls.time}. ¿Hay cupo disponible?`,
  openGym: (day: string) =>
