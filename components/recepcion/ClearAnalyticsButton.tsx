...
import { clearAnalyticsAction } from "@/app/actions/analytics";

/** Botón para borrar TODAS las analíticas, con confirmación en dos pasos. */
export function ClearAnalyticsButton() {
  ...
  return (
    <div className="inline-flex items-center gap-2">
      ...
      <form action={clearAnalyticsAction}>
        <button
          type="submit"
